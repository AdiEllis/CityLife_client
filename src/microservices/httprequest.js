...
let headers = {
    "PARAM_X_AUTH": localStorage.getItem("authUserToken") ? localStorage.getItem("authUserToken") : 'token_not_exists',
    "PARAM_ID_AUTH": localStorage.getItem("authUserId") ? localStorage.getItem("authUserId") : 0,
